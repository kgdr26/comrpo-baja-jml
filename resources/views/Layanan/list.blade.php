            ...
            <div class="row">
                ...
                <div class="col-md-12 centered">
                    <div class="custom-heading style-1 triggerAnimation animated" data-animate='fadeInUp'>
                        <h5 style="font-family:Trajan Pro Regular; color:#fbda9a;letter-spacing:2px;">Layanan Kami</h5>
                        <h3 style="font-family:baskervillenormal; text-transform:none; letter-spacing:-2px;">RUANG LINGKUP BISNIS Lorem Ipsume</h3>
        ...
        <div class="container">
            ...
            <div class="row m-0 p-0">
                ...
                <div class="col-md-6 col-sm-6">
                    <img src="../img/img_service1.jpg" alt="Lorem Ipsume" /><br>
                    <img src="../img/img_service2.jpg" alt="Lorem Ipsume" />
                </div><!-- .col-md-6 end -->
                ...
                <div class="col-md-6 col-sm-6 centered">
                    ...
                    <p align="center" style="color:#5b4c3d; margin-bottom:100px;">
                ...
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="../img/img_service3.jpg" alt="Lorem Ipsume" />
                </div><!-- .col-md-6 end -->
                
                <div class="col-md-12 col-sm-12" style="margin-top:15px;">
                    <img src="../img/img_service4.jpg" alt="Lorem Ipsume" />
                </div>
        ...
        <div class="container">
            ...
            <div class="row m-0 p-0">
                ...
                <div class="col-md-6 col-sm-6 centered">
                    ...
                    <p align="left" style="color:#5b4c3d; margin-bottom:75px;">
                    ...
                    <img src="../img/img_service5.jpg" alt="Lorem Ipsume" />
                
                </div><!-- .col-md-6 end -->
                
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="../img/img_service3.jpg" alt="Lorem Ipsume" /><br>
                    <img src="../img/img_service7.jpg" alt="Lorem Ipsume" />
                </div><!-- .col-md-6 end -->
    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="row m-0 p-0">
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="../img/img_service8.jpg" alt="Lorem Ipsume" />
                </div><!-- .col-md-6 end -->
                ...
                <!-- .col-md-6 start -->
                <div class="col-md-6 col-sm-6">
                    <img src="../img/img_service9.jpg" alt="Lorem Ipsume" />
                </div><!-- .col-md-6 end -->
